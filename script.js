...
const scenarios = [
  {
    id: "good",
    title: "Хорошая работа (4, две ошибки)",
    ...
    mistakes: [
      ...
      {
        severity: "minor",
        friendlyTitle: "Безударная гласная",
        original: "посодить",
        corrected: "посадить",
        explanation: "Проверочное слово — «сад». В корне пишется «а».",
        encouragement: "Ты почти везде проверяешь гласные верно — здесь просто не заметил.",
        taskNumber: "Упр. 135"
      }
    ]
  },
